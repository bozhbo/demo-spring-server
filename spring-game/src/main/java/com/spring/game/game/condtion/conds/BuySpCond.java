...
public class BuySpCond extends AbstractConditionCheck {
	...
	public AbstractConditionCheck generate(String[] agrs) {
		...
		return new BuySpCond(num);
	}

	@Override
	public int checkCond(RoleInfo roleInfo, int action,
			CheckDataChg questInProgress, int index, Object obj) {
		if (questInProgress == null || obj == null || action != ActionType.action13.getType()) {
			return 0;
		}
