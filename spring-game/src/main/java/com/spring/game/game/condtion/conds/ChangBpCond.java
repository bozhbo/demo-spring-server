...
public class ChangBpCond extends AbstractConditionCheck {
	...
	public AbstractConditionCheck generate(String[] agrs) {
		...
		return new ChangBpCond(num);
	}

	@Override
	public int checkCond(RoleInfo roleInfo, int action,
			CheckDataChg questInProgress, int index, Object obj) {
		if (questInProgress == null || action != ActionType.action383.getType()) {
			return 0;
		}
