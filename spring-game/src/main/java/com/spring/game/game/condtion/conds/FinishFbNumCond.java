 ...
 * 
 */
public class FinishFbNumCond extends AbstractConditionCheck {
	...
	public FinishFbNumCond() {
	}

	public FinishFbNumCond(int typeNo, int chapterNo, int battleNo, int num, int isOneKey) {
		this.typeNo = typeNo;
	...
	public AbstractConditionCheck generate(String[] agrs) {
		...
		return new FinishFbNumCond(typeNo, chapterNo, battleNo, num, isOneKey);
	}
