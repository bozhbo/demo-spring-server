...
public class HeroWearEquipCond extends AbstractConditionCheck {
	
	private int num;
	
	public HeroWearEquipCond() {
	}

	public HeroWearEquipCond(int num) {
		this.num = num;
	}
	...
	public AbstractConditionCheck generate(String[] agrs) {
		...
		return new HeroWearEquipCond(num);
	}

	@Override
	public int checkCond(RoleInfo roleInfo, int action,
			CheckDataChg questInProgress, int index, Object obj) {
		if (questInProgress == null || action != ActionType.action79.getType()) {
			return 0;
		}
