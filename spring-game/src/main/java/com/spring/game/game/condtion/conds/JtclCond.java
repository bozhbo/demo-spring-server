...
public class JtclCond extends AbstractConditionCheck {
	...
	public int checkCond(RoleInfo roleInfo, int action,
		...
		// 任务条件检测
		if (questInProgress == null || action != ActionType.action321.getType()) {
			return 0;
		}
