...
public class NzwdCond extends AbstractConditionCheck {
	...
	public int checkCond(RoleInfo roleInfo, int action,
		...
		// 任务条件检测
		if (questInProgress == null || action != ActionType.action362.getType() || obj == null) {
			return 0;
		}
