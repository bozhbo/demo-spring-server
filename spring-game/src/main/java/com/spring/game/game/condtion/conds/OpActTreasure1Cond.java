...
public class OpActTreasure1Cond extends AbstractConditionCheck {
	
	private int treasureNum;// 金币10连抽次数

	public OpActTreasure1Cond() {
	}

	public OpActTreasure1Cond(int treasureNum) {
	...
	public AbstractConditionCheck generate(String[] agrs) {
		...
		return new OpActTreasure1Cond(num);
	}
