...
public class QueryCheckInListProcessor extends ProtocolProcessor {
	...
	public void execute(Request request, Response response) {
		...
		header.setProtocolId(Command.CHECKIN_QUERY_RESP);

		QueryCheckInListResp resp = checkInMgtService.queryList(roleId);
