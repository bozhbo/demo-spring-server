...
public class FightValueProcessor extends ProtocolProcessor {
	...
	public void execute(Request request, Response response) {
		...
		head.setMsgType(Command.QUERY_FIGHT_VLAUE_RESP);
		int roleId = head.getUserID0();
		FightValueResp resp = heroMgtService.queryFightValue(roleId);
