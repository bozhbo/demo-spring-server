...
public class DisposeAddRequestProcessor extends ProtocolProcessor{
	...
	public void execute(Request request, Response response) {
		...
		header.setMsgType(Command.DISPOSE_ADD_REQUEST_RESP);
		
		int roleId = header.getUserID0();
		
		DisposeAddRequestReq req = (DisposeAddRequestReq) msg.getBody();
		
		DisposeAddRequestResp resp = roleRelationMgtService.disposeAddRequest(roleId, req);
